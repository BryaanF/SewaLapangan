...
@endsection
@section('content')
    <h2 class="text-center">Request Sewa Lapangan</h2>
            ...
            <div class="card mx-auto mt-4 w-50" style="height:600px">
                ...
                <div class="card-body" style="height: 50%">
                    ...
                    <div class="d-flex gap-3">
                        <a href="{{ route('accreqsewa', ['id' => $sewa->id]) }}" class="btn btn-primary">TERIMA</a>
                        <form class="" action="{{ route('tlkreqsewa', ['id' => $sewa->id]) }}" method="GET">
                            @csrf
                            @method('delete')
                            <button type="submit" class="btn btn-danger btn-delete">TOLAK</button>
                        </form>
